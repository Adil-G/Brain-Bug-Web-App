...
public class MainApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println(testit("what is an elephant"));
        dostuff("GET","what is an elephant".replaceAll("\\s","+"),0);
    }
    public static String testit(String query) throws Exception { WikipediaInfoBoxModel2OldJune14_PERSONAL.changeStatementsFileName("statements_july6.txt");
    ...
    public static String dostuff(String action,String query,int filename) throws IOException {
        //untitled1.rbjbakp2fm.us-west-2.elasticbeanstalk.com
        String url = "http://untitled1-1.rbjbakp2fm.us-west-2.elasticbeanstalk.com/MyServlet?" +
